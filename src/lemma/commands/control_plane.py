...
@control_plane_app.command(
    name="install",
    help="Render a deployment artifact for the Control Plane (systemd unit or docker-compose).",
)
def install_command(
    shape: str = typer.Option(..., "--shape", help="Deployment shape: systemd or docker-compose."),
    ...
    output_name, template = _INSTALL_SHAPES[shape]
    out_dir = Path(output)
    ...
    console.print(f"[green]Wrote[/green] {shape} Control Plane artifact to {target}")
    if shape == "systemd":
        console.print(
